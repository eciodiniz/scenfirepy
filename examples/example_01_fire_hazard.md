...
This example demonstrates how **scenfirepy** can be used to select a subset of candidate fire events whose size distribution reproduces a  
historical fire regime derived from **raster-based fire hazard data**. 
