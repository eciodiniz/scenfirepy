...
- Example 1 — - [Fire hazard–based scenario selection]([examples/example_01_fire_hazard.md](https://github.com/eciodiniz/scenfirepy/blob/main/examples/example_01_fire_hazard.md))
